...
//   const { AxiosPost, AxiosGet, AxiosDelete } = useAxiosHelper();
...
//   React.useEffect(() => {
//     fetchItems(filters);
//   }, [filters.search, filters.minPrice, filters.maxPrice, filters.page]); // Re-fetch when any filter changes

//   // When items change, update gridKey to retrigger animation
//   useEffect(() => {
//     // Only trigger animation for new data fetches, not for deletions
//     if (!isAnimating) {
...
//                   {loading ? 'Adding...' : (editingItem ? 'Update Item' : 'Add Item')}
//                 </button>
...
//       return;
//     }
// console.log("form data2222222222", formData)
//     setLoading(true);
//     try {
//       const itemId = editingItem.itemId || editingItem.id;
//       const res = await AxiosPut(`${ApiPaths.updateItem}/${itemId}`, formData);
...
//         setEditingItem(null);
//         setShowAddForm(false);
//         fetchItems(filters); // Refresh the items list
//       } else {
